 ...
 * @return {Object} - this
 */
function _mokaBaseColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_mokaBaseColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_mokaBaseColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_mokaBaseColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _mokaBaseColor object.
 *
 * @since 1.0.0
 * @param {string} backgroundColor - The background color.
 * @param {number} accentHue - The hue for our accent color.
 * @return {Object} - this
 */
function mokaBaseColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _mokaBaseColor( backgroundColor, accentHue );
